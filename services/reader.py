...
class ReaderService():
    ...
    def eliminar_repeticiones(self, texto):
    ...
    def unir_materias_divididas(self, texto):
    ...
    def procesar(self, texto):
        texto = self.eliminar_repeticiones(texto)
        texto = self.combinar_lineas(texto)
        texto = self.unir_materias_divididas(texto)
        texto = self.formato_final(texto)
        materias = self.extraer_notas(texto)
        return materias